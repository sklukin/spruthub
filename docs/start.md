# Руководство по настройке SprütHub Metrics
...
2. [Настройка скриптов SprütHub](#2-настройка-скриптов-sprüthub)
...
### Загрузка скриптов в SprütHub

1. Скопировать содержимое файлов из `global/` в глобальные скрипты SprütHub
